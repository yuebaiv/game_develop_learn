...
void UTP_WeaponComponent::Fire()
{
	...
	if (ProjectileClass != nullptr)
	{
		...
		if (World != nullptr)
		{
			AAndroidProjectPlayerController* PlayerController = Cast<AAndroidProjectPlayerController>(Character->GetController());
			...
			//准星抖动动画
			PlayerController->CrossHairWidget->PlayShootAnimation();
...
bool UTP_WeaponComponent::AttachWeapon(AAndroidProjectCharacter* TargetCharacter)
{
